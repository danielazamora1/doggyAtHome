...
<head>
	...
	<!-- Site favicon -->
	<link rel="website icon" href="vendors/images/RegistroUsuario.png">
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Información del usuario</h4><br>
						</div>
...
<a href="usuarios.php"><button class="btn btn-primary">Volver</button></a>
