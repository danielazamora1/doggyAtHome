	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<form action="inhabilitarArticulo2.php" method="post">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30" >
					<div class="col-lg-12 col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box text-center height-100-p">
							<h5 class="pt-20 h5 mb-30">¿Estás seguro de inhabilitar este articulo?</h5>
				...
				<br>
				<a href="listaArticulos.php"><button style="border-color: brown; background-color: brown;" class="btn btn-primary">Volver</button>
			</div>
			<br>
