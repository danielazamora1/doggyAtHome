...
<?php  
	...
	$sql = "SELECT * FROM seguimientoproceso WHERE idSeguimientoProceso = '$id'";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="seguimientoProceso.php">Lista Seguimientos</a></li>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Editar Seguimiento</h4><br>
						</div>
